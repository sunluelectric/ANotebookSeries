...
In \eqref{ch7eq:motivatingexp2doubleintegral}, two integrals are calculated one after another to finally obtain the volume of motivating example 2, where $dx$ and $dy$ are the infinitesimal change along $x$-axis and $y$-axis respectively, just like $\Delta x\rightarrow 0$ in Chapter \ref{ch3}.

Equation \eqref{ch7eq:motivatingexp2doubleintegral} can be alternatively comprehended as follows.
