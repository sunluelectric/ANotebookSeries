...
\chapter{Text File Editing in Linux}
...
\section{Vim Modes} \label{ch3:subsec:vimgeneralintro}
...
\begin{figure}
	\centering
	\includegraphics[width=4in]{chapters/chapter3/figures/vim_fib.png}
	\caption{\textit{Vim} (with user's profile customization as introduced in this chapter).}
\end{figure}

\begin{figure}
	\centering
	\includegraphics[width=4in]{chapters/chapter3/figures/nano_fib.png}
	\caption{\textit{Nano}.}
\end{figure}

\begin{figure}
	\centering
	\includegraphics[width=4in]{chapters/chapter3/figures/emacs_fib.png}
	\caption{\textit{Emacs}.}
\end{figure}

\begin{figure}
	\centering
	\includegraphics[width=4in]{chapters/chapter3/figures/gedit_fib.png}
	\caption{\textit{Gedit}.}
\end{figure}

\begin{figure}
	\centering
	\includegraphics[width=4in]{chapters/chapter3/figures/vscode_fib.png}
	\caption{\textit{Visual Studio Code}.}
\end{figure}

\begin{figure}
	\centering
	\includegraphics[width=4in]{chapters/chapter3/figures/atom_fib.png}
	\caption{\textit{Atom}.}
\end{figure}
