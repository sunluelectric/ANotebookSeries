...
We will use the most commonly used operator commands, \textbf{delete/cut}, \textbf{copy} (called ``\textbf{yank}'' in \textit{Vim}), \textbf{paste} and \textbf{replace} (called ``\textbf{change}'' in \textit{Vim}) to demonstrate the above idea.
...
\begin{table}
  ...
  \begin{tabularx}{\textwidth}{lX}
    ...
    \verb|d| & Delete/Cut something, depending on the motion. A sequential motion is required. \\
    \hline
  \end{tabularx}
\end{table}
...
\begin{table}
  ...
  \begin{tabularx}{\textwidth}{lX}
    ...
    \verb|\{|, \verb|\}| & One paragraph to the previous or next. \\ \hdashline
    ...
    \verb|i(|, \verb|i<|, \verb|i[|, \verb|i\{| & inner-block for different types of brackets. \\
    \hline
  \end{tabularx}
\end{table}
