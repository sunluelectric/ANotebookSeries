...
\begin{table}
  \centering \caption{Commonly used metacharacters.}\label{ch4tab:metacharacters}
  \begin{tabularx}{\textwidth}{lX}
    \hline
    Directory & Description \\ \hline
...
An example of using \verb|locate| is given in Fig. \ref{ch4fig:locateexp}. It can be seen from this example that the searching is done globally and does not rely on the current working directory.
\begin{figure}
	\centering
	\includegraphics[width=350pt]{chapters/chapter4/figures/locateexp.png}
	\caption{Search for files and directories using \textit{locate}.} \label{ch4fig:locateexp}
\end{figure}
